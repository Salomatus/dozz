...
Проект серверная часть виджета банковских операций - Это веб-приложение на Python который умеет отражать операции клиента
...
1. В файле main.py можно передавать различные именования номеров карт и счётов.
